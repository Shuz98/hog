...
def is_swap(score0, score1):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    ones_of_p0, tens_of_p1= score0%10, score1//10
    if  ones_of_p0 == tens_of_p1:
      return True
    else:
      return False
    # END PROBLEM 4
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    i, avg = 1, 0
    while i <= 10:
        k = make_averaged(roll_dice, num_samples)
        if k(i, dice) > avg:
            avg, num = k(i,dice), i
        i += 1
    return num
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if free >= margin:
        return 0
    elif is_swap(score + free, opponent_score) and (score + free)< opponent_score:
        return 0
    else:
        return num_rolls
    # Replace this statement
